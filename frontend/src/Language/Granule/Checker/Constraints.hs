          ...
          case demoteKindToType k of
            ...
            Just (TyCon k) ->
                  case internalName k of
                    ...
                    k -> solverError $ "Solver error: I don't know how to create an existntial for " <> show k

            Just k -> solverError $ "Solver error: I don't know how to create an existntial for demotable type " <> show k
