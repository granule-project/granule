...
data Constraint =
  -- Coeffect resource algebra constraints
    Eq  Span Coeffect Coeffect (Type Zero)
  | Neq Span Coeffect Coeffect (Type Zero)
  | ApproximatedBy Span Coeffect Coeffect (Type Zero)

  -- 
  | Lub Span Coeffect Coeffect Coeffect (Type Zero)
  ...
  | NonZeroPromotableTo Span Id Coeffect (Type Zero)
...
rewriteBindersInPredicate ctxt =
  ...
  where
    ...
    updateConstraint :: Id -> (Type Zero, Quantifier) -> Constraint -> Constraint
    ...
    updateCoeffect :: Id -> Type Zero -> Coeffect -> Coeffect
