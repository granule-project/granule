...
data Constraint =
  -- Coeffect resource algebra constraints
    Eq  Span Coeffect Coeffect (Type One)
  | Neq Span Coeffect Coeffect (Type One)
  | ApproximatedBy Span Coeffect Coeffect (Type One)

  -- 
  | Lub Span Coeffect Coeffect Coeffect (Type One)
  ...
  | NonZeroPromotableTo Span Id Coeffect (Type One)
...
rewriteBindersInPredicate ctxt =
  ...
  where
    ...
    updateCoeffect :: Id -> Type One -> Coeffect -> Coeffect
