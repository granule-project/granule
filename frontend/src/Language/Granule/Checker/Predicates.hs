...
data Constraint =
  -- Coeffect resource algebra constraints
    Eq  Span (Type Zero) (Type Zero) (Type One)
  | Neq Span (Type Zero) (Type Zero) (Type One)
  | ApproximatedBy Span (Type Zero) (Type Zero) (Type One)

  -- 
  | Lub Span Coeffect (Type Zero) (Type Zero) (Type One)
  ...
  | NonZeroPromotableTo Span Id (Type Zero) (Type One)

  -- Used for user-predicates, and also effect types
  | Lt Span   (Type Zero) (Type Zero) -- Must be Nat kinded
  | Gt Span   (Type Zero) (Type Zero) -- Must be Nat kinded
  | LtEq Span (Type Zero) (Type Zero) -- Must be Nat kinded
  | GtEq Span (Type Zero) (Type Zero) -- Must be Nat kinded
...
rewriteBindersInPredicate ctxt =
  ...
  where
    ...
    updateConstraint :: Id -> (Type One, Quantifier) -> Constraint -> Constraint
    ...
    updateCoeffect :: Id -> Type One -> Type Zero -> Type Zero
