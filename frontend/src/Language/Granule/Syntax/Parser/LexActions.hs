...
-}
module Language.Granule.Syntax.Parser.LexActions
    ( -- * Main function
      lexToken
      -- * Lex actions
      -- ** General actions
...
'Language.Granule.Syntax.Parser.Lexer.alexScanUser'. This is the main lexing function
where all the work happens. The function 'Language.Granule.Syntax.Parser.Lexer.lexer',
...
-- | Executed for layout keywords. Enters the 'Language.Granule.Syntax.Parser.Lexer.layout'
