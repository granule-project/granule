...
module Language.Granule.Syntax.Parser.Monad
    ( -- * The parser monad
      Parser
    , ParseResult(..)
    , ParseState(..)
...
--   "Language.Granule.Syntax.Parser.Layout" for more informaton.
...
-- | The most general way of parsing a string. The "Language.Granule.Syntax.Parser" will define
