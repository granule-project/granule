...
makeVar name (ForallTyS _ _ _ t) =
...
makeAbs name e (ForallTyS _ _ _ t@(FunTy _ t1 t2)) =
...
makeApp name e (ForallTyS _ _ _ t1) t2 =
  App s t1 False (makeVar name (ForallTyS nullSpanNoFile [] [] t2)) e
  where s = nullSpanNoFile

makeBox :: TypeScheme -> Expr () Type -> Expr () Type
makeBox (ForallTyS _ _ _ t) e =
...
makeUnboxP name1 expr (ForallTyS _ _ _ goalTy) boxTy varTy e  =
  App s goalTy False
  (Val s boxTy False
...
makePairElimP ptransf elimExpr lId rId (ForallTyS _ _ _ goalTy) lTy rTy e =
  App s goalTy False
...
makeUnitElimP patTransf argExpr e (ForallTyS _ _ _ goalTy) =
...
--makeEitherCase name lId rId (ForallTyS _ _ _ goalTy) lTy rTy =
